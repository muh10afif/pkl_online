...
<TABLE border="1" style="width:100%;border-collapse: collapse;border:1px solid #3851d0;"  class="bpmTopicC">
  <thead>
   <tr bgcolor="#3851d0" class="headerrow">
    ...
    <td align="center" style="padding:5px;"><span style="color:#fff; font-family:arial;">NAMA</span></td>
    <td align="center" style="padding:5px;"><span style="color:#fff; font-family:arial;">PEMBIMBING</span></td>
    ...
    <td align="center" style="padding:5px;"><span style="color:#fff; font-family:arial;">SEKOLAH/PERGURAN TINGGI</span></td>
    <td align="center" style="padding:5px;"><span style="color:#fff; font-family:arial;">JURUSAN</span></td>
    <td align="center" style="padding:5px;"><span style="color:#fff; font-family:arial;">KET. PKL</span></td>
   </tr>
  </thead>';
    $no=1;
    $jumlah=0;
    if (count($persetujuan)>0) {
    foreach ($persetujuan as $permohonan) 
       $html .="<tr>
...
// LOAD a stylesheet
$mpdf->SetTitle("Laporan Penerimaan PKL");
$mpdf->WriteHTML($html);

$mpdf->Output('Laporan Data Penerimaan.pdf', 'I');
