...
<TABLE border="1" style="width:100%;border-collapse: collapse;border:1px solid #3851d0;"  class="bpmTopicC">
  <thead>
   <tr bgcolor="#3851d0" class="headerrow">
    ...
    <td align="center" style="padding:5px;"><span style="color:#fff; font-family:arial;">ALAMAT</span></td>
    <td align="center" style="padding:5px;"><span style="color:#fff; font-family:arial;">JENIS KELAMIN</span></td>
    <td align="center" style="padding:5px;"><span style="color:#fff; font-family:arial;">AGAMA</span></td>
    <td align="center" style="padding:5px;"><span style="color:#fff; font-family:arial;">SEKOLAH</span></td>
    <td align="center" style="padding:5px;"><span style="color:#fff; font-family:arial;">ALAMAT SEKOLAH</span></td>
    ...
    <td align="center" style="padding:5px;"><span style="color:#fff; font-family:arial;">NO HP</span></td>
   </tr>
  </thead>';
    $no=1;
    $jumlah=0;
    ...
    foreach ($daftar as $permohonan) 
       $html .="<tr>
                  ...
                  <td style='padding:5px;'>".$permohonan->alamat."</td>
                  <td style='padding:5px;'>".$permohonan->jenis_kelamin."</td>
                  <td style='padding:5px;'>".$permohonan->agama."</td>
                  <td style='padding:5px;'>".$permohonan->nama_sekolah_perguruantinggi."</td>
                  <td style='padding:5px;'>".$permohonan->alamat_sekolah."</td>
                  ...
                  <td style='padding:5px;'>".$permohonan->no_hp."</td>
                </tr>";
      }else{
       $html .="<tr>
                  <td colspan=12 align='center' height='80' style='padding:5px;'>DATA YANG DIPILIH TIDAK ADA</td>
                </tr>";
...
$mpdf->Output('Laporan Data.pdf', 'I');
