...
<table width="100%" height="221">
	<tr>
		<td width="20%" align="right"><img src="http://localhost/webpklonline/uploads/logo/jabar.png" style="width:150px;height:160px;"></td>
   ...
   <tr bgcolor="#3851d0" class="headerrow">
    ...
    foreach ($daftar as $permohonan) {
       ...
       $html .="<tr bgcolor='#CCCCCC'>
                  ...
                  <td align='center' style='padding:5px;'>".$permohonan->NIS_NIM."</td>
                  <td align='center' style='padding:5px;'>".$permohonan->nama_lengkap."</td>
                  ...
                  <td align='justify' style='padding:5px;'>".$permohonan->tanggal_mulai."</td>
                  <td align='justify' style='padding:5px;'>".$permohonan->tanggal_selesai."</td>
...
$html.='</TABLE>';
$html.='<table>';
$html.="<td align='justify' style='padding:5px;'>".$jumlah."</td>";
$html.='</table>';
...
// LOAD a stylesheet
$mpdf->SetTitle("Laporan Permohonan");
$mpdf->WriteHTML($html);

$mpdf->Output('Laporan Data Permohonan.pdf', 'I');
